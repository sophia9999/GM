				...
				<tr>
					...
					<td>
						...
						<c:if test="${empty dto.subject}">
							<button type="button" class="btn" onclick="location.href='${pageContext.request.contextPath}/review/write.do?odNum=${dto.odNum}&cdNum=${dto.cdNum}';">리뷰등록</button>
						</c:if>
					</td>
